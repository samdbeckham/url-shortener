...
app.include_router(
    read_all_endpoint.router, prefix=api_prefix, dependencies=[Depends(verify_api_key)]
)
app.include_router(
    shorten_endpoint.router, prefix=api_prefix, dependencies=[Depends(verify_api_key)]
)
app.include_router(
    delete_endpoint.router, prefix=api_prefix, dependencies=[Depends(verify_api_key)]
)
